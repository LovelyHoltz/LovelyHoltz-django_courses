...
def showAddForm(request):
    if request.session['user_id']:
        return render(request, 'bookreviw_app/add.html',
...
def showOneBook(request, number):
    if request.session['user_id']:
        ...
        print this_book
        return render(request, 'bookreview_app/book.html',
...
def showUser(request, number):
    if request.session['user_id']:
        ...
        return render(request, 'bookreview_app/user.html', {"user": this_user,
